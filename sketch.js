...
function blueBalloon() {
  ...
  var blue = createSprite(0,Math.round(random(40, 320)), 10, 10)
...
function greenBalloon() {
  //crieSprite para o balão
  var green = createSprite(0,Math.round(random(57, 220)), 10, 10)
  //adicioneImagem para o balão
...
function pinkBalloon() {
 //crieSprite para o balão
 var pink = createSprite(0,Math.round(random(70, 120)), 10, 10)
  //adicioneImagem para o balão
